...
const Login = () => {
  ...
  return (
    <Paper elevation={10} style={{ width: '100vw', height: '100vh' }} >
      <Paper elevation={24} style={{ width: '90vw', margin: '0 auto', position: 'relative', top: '20%' }}>
        <Box
          component="form"
          sx={{
            '& > :not(style)': { m: 1 },
        ...
        >
          ...
          <Input
            ...
            label='密码'
          />
          <LoadingButton variant="contained" onClick={handleLogin} loading={loading}>登录</LoadingButton>
          <div>
            <Button variant="text" onClick={handleOffline} >离线使用</Button>
            <Button variant="text" onClick={() => navigate('/register', { replace: true })}>注册</Button>
          </div>
        </Box>
      </Paper>

...
export const PersonTotalFiveInsureRate = Object.keys(
  PersonFiveInsureRate
).reduce((prev, key) => (prev += PersonFiveInsureRate[key]), 0);
...
export const CompanyTotalFiveInsureRate = Object.keys(
  CompanyFiveInsureRate
).reduce((prev, key) => (prev += CompanyFiveInsureRate[key]), 0);
